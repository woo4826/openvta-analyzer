...
- [x] **Step 3: Implement the validated preference boundary**
...
- [x] **Step 1: Change component tests to require the top-bar workspace**
...
- [x] **Step 3: Add `TopbarFileWorkspace`**
...
- [x] **Step 4: Remove the file rail and simplify the workspace grid**
...
- [x] **Step 4: Implement `SegmentRangeNavigator`**
...
- [x] **Step 5: Run navigator and hook tests**
...
- [x] **Step 3: Add visibility-aware workbench selectors**
...
- [x] **Step 4: Implement the floating drawer**
...
- [x] **Step 5: Filter presentation consumers only**
...
- [x] **Step 1: Install and inspect the grid library**
...
- [x] **Step 3: Implement the grid adapter**
...
- [x] **Step 4: Convert existing analysis blocks to widgets**
...
- [x] **Step 1: Update the browser test for the new information architecture**
...
- [x] **Step 1: Start the app and verify with Aside**
